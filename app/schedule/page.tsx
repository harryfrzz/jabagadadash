                                ...
                                <table className="w-full border-collapse">
                                    <thead>
                                        <tr className="bg-[rgba(239,219,146,0.1)] backdrop-blur-sm">
                                            ...
                                            <th className="text-left text-[#efdb92] py-5 px-6 font-semibold text-lg border-b-2 border-[rgba(239,219,146,0.3)] font-jetbrains-mono">Category</th>
                                    ...
                                    <tbody className="text-gray-300">
                                        {fest.events.map((event, eventIndex) => (
                                            <tr key={eventIndex} className="border-b border-[rgba(255,255,255,0.05)] hover:bg-[rgba(239,219,146,0.08)] transition-all duration-200 group">
                                                ...
                                                <td className="py-5 px-6 text-gray-400 font-jetbrains-mono text-sm">{event.category}</td>
